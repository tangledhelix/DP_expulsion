...
* [x] Add **anonymized** files to git, e.g. `expulsion-smoothread01.txt`
...
* [x] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID65b02a36b02ff))
