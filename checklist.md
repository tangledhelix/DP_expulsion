...
./make_project.py
```
* [ ] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID65b02a36b02ff#project-comments)
* [ ] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=81031) and read all posts
* [ ] Open `expulsion-utf8.txt` in Guiguts
