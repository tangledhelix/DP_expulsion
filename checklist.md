...
"The expulsion of the Jews from England in 1290." by Abrahams, Barnett Lionel
...
./make_project.py
```
* [x] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID65b02a36b02ff#project-comments)
* [x] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=81031) and read all posts
* [x] Open `expulsion-utf8.txt` in Guiguts
...
### Unicode EN dashes
For now, do not process EM dash. The EM dash and long dash (2x EM) are left for after the text/html split.
...
* [x] Re-open `expulsion-utf8.txt` (if not still open).
...
* [x] Open `expulsion.html` that was saved previously.
...
* [x] Semantic fixup for italics
  * Use the Regex Library tool and `italic_semantic.json`.
...
* [x] Optional: Add epub3, kepub to Dropbox for Kobo
...
* [x] Review Ebook ToC in at least one e-reader, for structure & content
  ...
  * [x] Footnote 87 contains poetry and an aligned attribution.
* [x] Mac
...
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID65b02a36b02ff), select SR time period, upload `expulsion-sr.zip`
...
* [ ] Add **anonymized** files to git, e.g. `expulsion-smoothread01.txt`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID65b02a36b02ff))
...
* [ ] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID65b02a36b02ff)
